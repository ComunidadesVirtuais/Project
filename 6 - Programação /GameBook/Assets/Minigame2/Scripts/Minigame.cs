...
public class Minigame : MonoBehaviour {
	...
	//public int numberLevels = 15; // numero de jogadas possiveis
	private int actualLevel;
	private float numberSet = 3.0f; // quantas setas
	GameObject arrows;
	...
	void Start ()
	{
		print ("entrou no minigame swape");
	//	try{
	...
	public void PlayerAnswer(int value)
	{
		...
		if (actualLevel <= numberLevels) Invoke("PlaceAtRandomPosition",timeForNextTurn);
